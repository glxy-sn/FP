...
public class Guest extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        String no = noBPJS.getText();
        String hp = telp.getText();
        String appoinment = null;
        String complaints = disease.getSelectedItem().toString();
        ...
        if (name.equals("")||no.equals("")||hp.equals("")||JK.equals("[blank]")||old.equals("")||complaints.equals("[blank]")||apptime == null||appoinment == null){
            ...
            try {
                ...
                if (appoinment != null){
                    ps.setString(7, appoinment);
                }else{
                    ps.setNull(7, 0);
                }
                ps.setString(8, apptime);
