...
public class Admin extends javax.swing.JFrame {
    ...
    private void submitAdmLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitAdmLoginActionPerformed
        ...
        if(email().isEmpty() || pass().isEmpty()){
            JOptionPane.showMessageDialog(null,  "You have not entered data!", "Empty Field", JOptionPane.WARNING_MESSAGE);
        } else if(email().isBlank() || pass().isBlank()){
            JOptionPane.showMessageDialog(null,  "Input can not blank (Space)!", "Blank Field", JOptionPane.WARNING_MESSAGE);
        } else {
            PreparedStatement ps;
        ResultSet rs;
        String email = email();
        String pass = pass();
        String query = "SELECT * FROM `data_login` WHERE `id`=? AND `pass`=?";
        try {
